...
if( $previous_post ) {
	...
	$previous_title = get_the_title( $previous_post ) ? get_the_title( $previous_post ) : __("The Previous Post", 'cele');
	// get the post link
...
// if there isn't a previous post
	...
	$previous_title = __('Return to Blog', 'cele');
	// link to blog
...
if( $next_post ) {
	...
	$next_title = get_the_title( $next_post ) ? get_the_title( $next_post ) : __("The Next Post", 'cele');
	// get the post link
...
// if there isn't a next post
	...
	// set the title to return to the blog
	$next_title = __('Return to Blog', 'cele');
	// link to blog
	$next_link = home_url();
}
